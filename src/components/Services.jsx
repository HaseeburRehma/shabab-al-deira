          ...
          {SERVICES.map((s, i) => (
            <Reveal key={s.slug} delay={(i % 3) * 0.1}>
              <motion.article
                ...
                className="group relative h-full overflow-hidden rounded-3xl bg-cream shadow-[0_20px_50px_-30px_rgba(74,54,38,0.6)] ring-1 ring-linen/50"
              >
                <Link to={`/services/${s.slug}`} className="block">
                  ...
                  <div className="p-7">
                    ...
                    <span className="mt-5 inline-flex items-center gap-2 font-display text-sm font-semibold text-accent transition-all duration-300 group-hover:gap-3">
